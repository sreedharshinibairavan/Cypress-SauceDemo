...
/* Before All */
before(function() {
  /* added this step to avoid before running twice
     (Hack for an existing cypress issue where the before runs twice) */
  if (Cypress.config('firstRun')) {
    ...
    Cypress.on('uncaught:exception', () => {
      /* returning false here prevents Cypress from failing
      the test if there are any exceptions from 3rd party scripts */
      return false;
    });
